...

  {
	...
	
	{
	  ...
	  children: [
	    {
	      path: 'list',
	      component: () => import('@/views/snackbox/school'),
	      name: 'schoolList',
	      meta: {
	        perms: ['GET /admin/school/list', 'POST /admin/school/create'],
	        title: '学校管理',
	        noCache: true
	      }
	    },
			{
			  path: 'addschool',
			  component: () => import('@/views/snackbox/addschool'),
			  name: 'addschool',
			  meta: {
			    perms: ['POST /admin/school/create'],
			    title: '添加学校',
			    noCache: true
			  },
				hidden: true
			...
			{
			  path: 'editschool',
			  component: () => import('@/views/snackbox/editschool'),
			  name: 'editschool',
			  meta: {
			    perms: ['GET /admin/school/get', 'POST /admin/school/update'],
			    title: '编辑学校',
			    noCache: true
			  },
				hidden: true
			...
			{
			  path: 'boxlist',
			  component: () => import('@/views/snackbox/boxlist'),
			  name: 'boxlist',
			  meta: {
			    perms: ['GET /admin/goods/list', 'POST /admin/goods/delete'],
			    title: '零食盒',
			...
			{
			  path: 'createbox',
			  component: () => import('@/views/snackbox/createbox'),
			  name: 'createbox',
			  meta: {
			    perms: ['GET /admin/goods/list', 'POST /admin/goods/delete'],
			    title: '创建零食盒',
			...
			{
			  path: 'editbox',
			  component: () => import('@/views/snackbox/editbox'),
			  name: 'editbox',
			  meta: {
			    perms: ['GET /admin/goods/list', 'POST /admin/goods/delete'],
			    title: '修改零食盒',
