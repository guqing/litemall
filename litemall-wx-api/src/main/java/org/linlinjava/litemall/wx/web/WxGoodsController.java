...
public class WxGoodsController {
	...
	/**
	 * 根据商品的id查询商品信息，用户是可选登录
	 * @return 根据条件搜素的商品详情
	 */
	@GetMapping("/listByIds")
	public Object listByIds(String goodsIds, Integer page, Integer limit) {
		//查询列表数据
		List<Integer> goodsIdList = JSONArray.parseArray(goodsIds, Integer.class);
		List<LitemallGoods> goodsList = goodsService.queryByIds(goodsIdList, page, limit);
